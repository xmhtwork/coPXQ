...
public class SubTask_GetDescendant
  implements Runnable
{
  int taskID;
  ...
  SubTask_GetDescendant(int taskID, CountDownLatch latch, ArrayList<RegionEncoding> rc, ArrayList<IndexNode>[] MNode, NameIDtable nameIDtable, String nameString, ArrayList<Integer> input_ids, ArrayList<Integer> result_ids)
  {
    this.taskID = taskID;
    this.latch = latch;
    this.rc = rc;
